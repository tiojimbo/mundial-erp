...
async function main() {
  ...
  // NOTA: secao 11 (BPM Process Instances) removida no sprint 7 (HPP-126).
  // Motor BPMN decommissionado — tabelas process/activity/task/handoff_instances
  // sao dropadas pela migration revert_bpm_runtime.
