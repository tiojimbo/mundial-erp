...
export class StockRequisitionItemResponseDto {
  ...
  ): StockRequisitionItemResponseDto {
    const dto = new StockRequisitionItemResponseDto();
    dto.id = entity.id as string;
    dto.productId = entity.productId as string;
    dto.productCode =
      ((entity.product as Record<string, unknown>)?.code as string) ??
      undefined;
    dto.productName =
      ((entity.product as Record<string, unknown>)?.name as string) ??
      undefined;
    dto.productEan =
      ((entity.product as Record<string, unknown>)?.barcode as string) ??
      undefined;
...
export class StockRequisitionResponseDto {
  ...
  @ApiProperty({ type: [StockRequisitionItemResponseDto] })
  items: StockRequisitionItemResponseDto[];
  ...
  static fromEntity(
    ...
    dto.requestedByName =
      ((entity.requestedBy as Record<string, unknown>)?.name as string) ??
      undefined;
    dto.approvedByUserId = (entity.approvedByUserId as string) ?? undefined;
    dto.approvedByName =
      ((entity.approvedBy as Record<string, unknown>)?.name as string) ??
      undefined;
    dto.orderId = (entity.orderId as string) ?? undefined;
    dto.orderNumber =
      ((entity.order as Record<string, unknown>)?.orderNumber as string) ??
      undefined;
