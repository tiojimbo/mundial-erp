...
export class InvoicesController {
  ...
  @ApiHeader({ name: 'Idempotency-Key', required: true, description: 'Chave de idempotência única para emissão' })
  ...
  @Get()
  @Roles(Role.ADMIN, Role.MANAGER, Role.OPERATOR)
  @ApiOperation({ summary: 'Listar notas fiscais (filtro direção/cliente/empresa/pedido)' })
  ...
  findAll(
    ...
    return this.invoicesService.findAll(pagination, { direction, clientId, companyId, orderId });
  }
