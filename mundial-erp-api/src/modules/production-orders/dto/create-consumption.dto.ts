...
export class CreateConsumptionDto {
  @ApiProperty({
    example: 'clxyz123',
    description: 'ID do ingrediente (produto matéria-prima)',
  })
  @IsString()
  @IsNotEmpty()
  ingredientId: string;
  ...
  @ApiPropertyOptional({
    example: 48.5,
    description: 'Quantidade real consumida',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 1500,
    description: 'Custo unitário em centavos',
  })
  @IsOptional()
  @IsNumber()
  costCents?: number;
  ...
  @ApiPropertyOptional({
    example: 75000,
    description: 'Custo total em centavos',
  })
  @IsOptional()
  @IsNumber()
