  ...
  return (
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          style={{ width: '458.4px' }}
          className='shadow-lg fixed left-[50%] top-[50%] z-50 flex translate-x-[-50%] translate-y-[-50%] flex-col overflow-hidden rounded-lg border border-[oklch(0.922_0_0)] bg-white'
        >
          {/* Form */}
          <form onSubmit={handleSubmit} className='flex flex-col'>
            ...
            <div className='flex flex-col gap-3 p-5'>
              ...
              <div className='flex flex-col gap-2 pr-8 text-left'>
                ...
                <Dialog.Description className='text-[14px] font-normal leading-snug text-[oklch(0.556_0_0)]'>
                  É nos canais do chat que as conversas acontecem. Use um nome
                  que seja fácil de encontrar e entender.
                </Dialog.Description>
              </div>
            ...
            >
              <button
                ...
                className='shadow-xs inline-flex h-9 cursor-pointer items-center justify-center rounded-md bg-[oklch(0.145_0_0)] px-4 py-2 text-[14px] font-medium text-white outline-none transition-all hover:bg-[oklch(0.205_0_0)] disabled:cursor-not-allowed disabled:opacity-50'
              >
