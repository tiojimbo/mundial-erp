        ...
        <div className='flex flex-col gap-3 sm:flex-row'>
          <div className='relative flex-1'>
            ...
            <input
              ...
              className='shadow-xs w-full rounded-lg border border-stroke-soft-200 bg-bg-white-0 py-2 pl-9 pr-3 text-paragraph-sm placeholder:text-text-soft-400 focus:border-primary-base focus:outline-none'
            />
          </div>
          <select
            value={roleFilter}
            ...
            className='shadow-xs rounded-lg border border-stroke-soft-200 bg-bg-white-0 px-3 py-2 text-paragraph-sm'
          >
          ...
          <select
            value={deptFilter}
            onChange={(e) => {
              setDeptFilter(e.target.value as Department | '');
              setPage(1);
            }}
            className='shadow-xs rounded-lg border border-stroke-soft-200 bg-bg-white-0 px-3 py-2 text-paragraph-sm'
          >
