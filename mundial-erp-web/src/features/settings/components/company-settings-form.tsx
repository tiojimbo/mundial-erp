    ...
    <form onSubmit={handleSubmit(onSubmit)} className='max-w-2xl space-y-6'>
      ...
      <div className='grid gap-4 sm:grid-cols-2'>
        <div className='space-y-1.5 sm:col-span-2'>
          ...
          <input
            {...register('name')}
            className='shadow-xs w-full rounded-xl border border-stroke-soft-200 bg-bg-white-0 px-3 py-2.5 text-paragraph-sm text-text-strong-950 placeholder:text-text-soft-400 focus:border-primary-base focus:outline-none focus:ring-1 focus:ring-primary-base'
          />
          {errors.name && (
