      ...
      <Modal.Content>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-4 p-4'>
          <div className='space-y-1.5'>
            ...
            <input
              {...register('name')}
              className='shadow-xs w-full rounded-xl border border-stroke-soft-200 bg-bg-white-0 px-3 py-2.5 text-paragraph-sm placeholder:text-text-soft-400 focus:border-primary-base focus:outline-none focus:ring-1 focus:ring-primary-base'
            />
            {errors.name && (
          ...
          <div className='grid grid-cols-2 gap-4'>
            <div className='space-y-1.5'>
              ...
              <select
                {...register('role')}
                className='shadow-xs w-full rounded-xl border border-stroke-soft-200 bg-bg-white-0 px-3 py-2.5 text-paragraph-sm focus:border-primary-base focus:outline-none focus:ring-1 focus:ring-primary-base'
              >
