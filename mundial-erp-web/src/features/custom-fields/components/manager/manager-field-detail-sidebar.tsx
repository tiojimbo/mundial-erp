...
function Switch({
  ...
  return (
    ...
    >
      <span
        className={cn(
          'shadow pointer-events-none block h-4 w-4 rounded-full bg-background ring-0 transition-transform',
...
export function ManagerFieldDetailSidebar({
  ...
  useEffect(() => {
    ...
    const dv = typeof def.defaultValue === 'string' ? def.defaultValue : '';
  ...
  return (
    <aside
      ...
      className='flex min-h-0 w-[min(100%,340px)] min-w-[300px] shrink-0 flex-col border-l border-border bg-background'
    >
      <header className='flex shrink-0 items-center justify-between border-b border-border px-4 py-3'>
        <button
          type='button'
          onClick={() => toast.info('O tipo do campo não pode ser alterado.')}
        ...
        <div className='space-y-4'>
          <div>
            ...
            <div className='relative'>
              <input
                ...
                className='focus-visible:ring-ring/50 h-9 w-full rounded-md border border-input bg-transparent pl-3 pr-9 text-paragraph-sm outline-none focus-visible:ring-[3px] disabled:opacity-50'
              />
              <button
                type='button'
                disabled
                ...
                className='absolute right-1.5 top-1/2 inline-flex size-7 -translate-y-1/2 cursor-not-allowed items-center justify-center rounded text-muted-foreground opacity-50'
              >
          ...
          {def.type === 'CURRENCY' ? (
            <div>
              ...
              <select
                ...
                className='focus-visible:ring-ring/50 h-9 w-full cursor-pointer rounded-md border border-input bg-transparent px-3 text-paragraph-sm outline-none focus-visible:ring-[3px] disabled:opacity-50'
              >
          ...
          {def.type === 'DATE' ? (
            <div className='flex items-center justify-between'>
              ...
              <Switch
                ...
                disabled={isBuiltin}
                onChange={(v) => setConfig((c) => ({ ...c, includeTime: v }))}
              />
            </div>
          ) : null}
          ...
          {def.type === 'RATING' ? (
            <div>
              ...
              <input
                ...
                className='focus-visible:ring-ring/50 h-9 w-full rounded-md border border-input bg-transparent px-3 text-paragraph-sm outline-none focus-visible:ring-[3px] disabled:opacity-50'
              />
            </div>
          ) : null}
            ...
            <div>
              ...
              <div className='flex items-center gap-2'>
                <input
                  ...
                  className='focus-visible:ring-ring/50 h-9 w-1/2 rounded-md border border-input bg-transparent px-3 text-paragraph-sm outline-none focus-visible:ring-[3px] disabled:opacity-50'
                />
                <input
                  type='number'
                  placeholder='Máx'
          ...
          {def.type === 'PEOPLE' ? (
            <div className='flex items-center justify-between'>
              ...
              <Switch
                ...
                disabled={isBuiltin}
                onChange={(v) => setConfig((c) => ({ ...c, multiple: v }))}
              />
            </div>
          ) : null}
          ...
          {def.type === 'CNPJ' ? (
            <div className='flex items-center justify-between'>
              ...
              <Switch
                ...
                disabled={isBuiltin}
                onChange={(v) => setConfig((c) => ({ ...c, cnpjAutofill: v }))}
              />
            </div>
          ) : null}
              ...
              <div className='mb-1.5 flex items-center justify-between'>
                ...
                <div className='relative'>
                  <button
                    ...
                    className='inline-flex h-7 cursor-pointer items-center gap-1 rounded-md px-2 text-paragraph-xs text-muted-foreground hover:text-foreground'
                  >
                    {sortMode === 'manual'
                      ? 'Manual'
                      : sortMode === 'alpha'
                  ...
                  {sortOpen ? (
                    <>
                      ...
                      />
                      <div className='absolute right-0 z-50 mt-1 w-40 rounded-md border bg-popover p-1 shadow-regular-md'>
                        {(['manual', 'alpha', 'alpha_desc'] as const).map(
                          (m) => (
                            <button
                              ...
                              className='flex w-full cursor-pointer items-center rounded-md px-2 py-1.5 text-left text-paragraph-sm hover:bg-accent'
                            >
                              {m === 'manual'
                                ? 'Manual'
                                : m === 'alpha'
                ...
                {(sortMode === 'manual'
                  ...
                  >
                    ...
                    <div className='relative'>
                      ...
                      {openColorIdx === i && !isBuiltin ? (
                        <>
                          ...
                          />
                          <div className='absolute left-0 top-5 z-50 grid w-44 grid-cols-5 gap-1.5 rounded-md border bg-popover p-2 shadow-regular-md'>
                    ...
                    <input
                      ...
                      className='focus-visible:ring-ring/50 h-8 flex-1 rounded-md border border-input bg-transparent px-2 text-paragraph-sm outline-none focus-visible:ring-[3px] disabled:opacity-50'
                    />
                    <button
                      type='button'
                      aria-label={
                    ...
                    <button
                      ...
                      className='inline-flex size-6 shrink-0 cursor-pointer items-center justify-center rounded text-muted-foreground hover:text-destructive disabled:cursor-not-allowed disabled:opacity-50'
                    >
                ...
                {!isBuiltin ? (
                  <div className='flex items-center gap-1'>
                    <button
                      ...
                      className='inline-flex cursor-pointer items-center gap-1.5 rounded-md px-1 py-1 text-paragraph-xs text-muted-foreground transition-colors hover:text-foreground'
                    >
                    ...
                    <button
                      ...
                      className='inline-flex h-7 cursor-not-allowed items-center justify-center gap-1 rounded-md px-2 text-paragraph-xs text-muted-foreground opacity-50'
                    >
              ...
              <div className='mt-4 space-y-5'>
                <div>
                  ...
                  <textarea
                    ...
                    className='focus-visible:ring-ring/50 min-h-[60px] w-full resize-none rounded-md border border-input bg-transparent px-3 py-2 text-paragraph-sm outline-none focus-visible:ring-[3px] disabled:opacity-50'
                  />
                </div>
                ...
                <div>
                  ...
                  <div className='flex items-center gap-2'>
                    <button
                      ...
                      className='flex h-9 flex-1 cursor-pointer items-center justify-between rounded-md border border-input bg-transparent px-3 text-paragraph-sm'
                    >
                ...
                <div>
                  ...
                  <p className='mb-2 text-paragraph-xs text-muted-foreground'>
                  ...
                  {def.creator ? (
                    <div className='flex items-center justify-between rounded-md px-1 py-1.5'>
                      <div className='flex items-center gap-2'>
                        <div className='flex h-6 w-6 items-center justify-center rounded-full bg-muted text-paragraph-xs font-medium'>
                      ...
                      <span className='inline-flex items-center gap-1 text-paragraph-xs text-muted-foreground'>
                        Permitido editar
                  ...
                  <button
                    ...
                    disabled
                    title='Em breve'
                    className='bg-muted/50 mt-1 inline-flex h-8 w-full cursor-not-allowed items-center justify-center gap-1.5 rounded-md text-paragraph-sm text-muted-foreground'
                  >
                    <Plus className='h-3.5 w-3.5' />
                    Adicionar exceção
                  </button>
                ...
                <div>
                  ...
                  <div className='space-y-3'>
                    <div>
                      ...
                      <p className='mt-1 text-paragraph-xs text-muted-foreground'>
                ...
                <div className='border-t pt-4'>
                  <FieldLabel>
                    Pertence a <span className='text-destructive'>*</span>
                  </FieldLabel>
                          ...
                          {!isBuiltin ? (
                            <div className='flex items-center gap-1 opacity-0 group-hover:opacity-100'>
                                ...
                                {changeLocOpenKey === key ? (
                                  <>
                                    <button
                                      ...
                                      tabIndex={-1}
                                      className='fixed inset-0 z-40 cursor-default'
                                      onClick={() => setChangeLocOpenKey(null)}
                                    />
                                    <div className='absolute right-0 z-50 mt-1 max-h-64 w-56 overflow-auto rounded-md border bg-popover p-1 shadow-regular-md'>
                                      {others.map((o) => (
                                        <button
                                          key={o.value}
                                          type='button'
                              ...
                              <button
                                ...
                                className='inline-flex size-6 cursor-pointer items-center justify-center rounded text-muted-foreground hover:text-destructive disabled:opacity-50'
                              >
                                <X className='h-3.5 w-3.5' />
                              </button>
                            </div>
                    ...
                    {!isBuiltin ? (
                      <div className='relative'>
                        <button
                          ...
                          className='inline-flex w-full cursor-pointer items-center gap-1.5 rounded-md px-2 py-1.5 text-paragraph-sm text-muted-foreground hover:text-foreground disabled:opacity-50'
                        >
                          <Plus className='h-3.5 w-3.5' />
                        ...
                        {addLocOpen ? (
                          <>
                            ...
                            />
                            <div className='absolute left-0 right-0 z-50 mt-1 max-h-64 overflow-auto rounded-md border bg-popover p-1 shadow-regular-md'>
                              {locationOptions
                                .filter(
                                  (o) =>
                                    !def.locations.some(
                                      (l) => `${l.type}:${l.id}` === o.value,
                                    ),
                                )
                                .map((o) => (
                                  <button
          ...
          {!isBuiltin ? (
            <div className='border-destructive/30 mt-2 border-t pt-4'>
              ...
              <p className='mb-2 text-paragraph-xs text-muted-foreground'>
                Excluir o campo remove a definição e todos os valores vinculados
                às tarefas. Ação não pode ser desfeita.
              </p>
              <button
                type='button'
                onClick={handleDelete}
                disabled={deleteMutation.isPending}
                className='border-destructive/40 hover:bg-destructive/10 inline-flex h-9 cursor-pointer items-center gap-2 rounded-md border bg-background px-3 text-paragraph-sm font-medium text-destructive transition-colors disabled:pointer-events-none disabled:opacity-50'
              >
