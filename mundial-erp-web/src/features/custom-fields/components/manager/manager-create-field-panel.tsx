  ...
  return (
    ...
    >
      <header className='flex shrink-0 items-center justify-between border-b border-border px-4 py-3'>
        <button
          type='button'
          onClick={() => toast.info('Escolha o tipo ao criar um novo campo.')}
          ...
          <div>
            ...
            <div className='relative'>
              <input
                ...
                className='focus-visible:ring-ring/50 h-9 w-full rounded-md border border-input bg-transparent pl-3 pr-9 text-paragraph-sm outline-none focus-visible:ring-[3px]'
              />
              <button
                type='button'
                disabled
            ...
            <div>
              ...
              <div className='flex items-center gap-2'>
                <input
                  ...
                  className='focus-visible:ring-ring/50 h-9 w-1/2 rounded-md border border-input bg-transparent px-3 text-paragraph-sm outline-none focus-visible:ring-[3px]'
                />
                <input
                  type='number'
                  placeholder='Máx'
                ...
                {(sortMode === 'manual'
                  ...
                  >
                    ...
                    <input
                      ...
                      className='focus-visible:ring-ring/50 h-8 flex-1 rounded-md border border-input bg-transparent px-2 text-paragraph-sm outline-none focus-visible:ring-[3px]'
                    />
                    <button
                      type='button'
                      aria-label={
                    ...
                    <button
                      ...
                      className='inline-flex size-6 shrink-0 cursor-pointer items-center justify-center rounded text-muted-foreground hover:text-destructive'
                    >
          ...
          {(() => {
            ...
            return (
              <div className='border-t pt-3'>
                ...
                <div className='flex items-center gap-2'>
                  <span className='inline-flex size-5 items-center justify-center rounded text-muted-foreground'>
