...
const TYPE_ICON: Record<CustomFieldType, { Icon: typeof Type; color: string }> =
  {
    ...
    QUANTITY: { Icon: Scale, color: 'text-amber-600' },
        ...
        <div className='flex items-center gap-2'>
          <div className='relative w-56'>
            ...
            <input
              ...
              className='focus-visible:ring-ring/50 h-6 w-full rounded-md border border-[#e8e8e8] bg-transparent pl-7 pr-2 text-paragraph-sm outline-none focus-visible:ring-[3px]'
            />
          </div>
          <div className='relative'>
            ...
            {typeFilterOpen ? (
              <>
                ...
                />
                <div className='absolute left-0 z-50 mt-1 w-56 rounded-md border bg-popover p-1 shadow-regular-md'>
                  <button
                    type='button'
                    onClick={() => {
                  ...
                  {availableTypes.map((t) => {
                    ...
                    return (
                      <button
                        ...
                        className='flex w-full cursor-pointer items-center gap-2 rounded-md px-2 py-1.5 text-left text-paragraph-sm hover:bg-accent'
                      >
          ...
          <div className='relative ml-auto'>
            <button
              ...
              className='inline-flex h-6 shrink-0 cursor-pointer items-center justify-center rounded-md bg-[#202020] px-2 text-subheading-xs text-white shadow-regular-xs transition-all hover:bg-[#363636]'
            >
              Criar novo
            </button>
            {typePickerOpen ? (
              <>
                ...
                />
                <div className='absolute right-0 z-50 mt-1 w-[280px] rounded-md border bg-popover p-1 shadow-regular-md'>
                  <div className='relative px-1 py-1'>
                    ...
                    <input
                      ...
                      className='focus-visible:ring-ring/50 h-8 w-full rounded-md border border-input bg-transparent pl-8 pr-2 text-paragraph-sm outline-none focus-visible:ring-[3px]'
                    />
                  </div>
                  <button
                    type='button'
                  ...
                  <div className='max-h-72 overflow-auto py-1'>
                    <div className='px-2 pb-1 pt-1.5 text-subheading-xs text-[#838383]'>
                      Todos
                    </div>
          ...
          <table className='w-full'>
            <thead>
              <tr className='border-b text-left text-paragraph-xs text-[#838383]'>
                ...
                <th className='pb-2 pr-4 font-normal'>Criado por</th>
                <th className='pb-2 pr-4 font-normal'>Data de criação</th>
                <th className='pb-2 pr-4 font-normal'>Localizações</th>
        ...
        <>
          {[...items]
            ...
            .map((item) => (
              ...
              >
                <td className='w-6 py-1.5' onClick={(e) => e.stopPropagation()}>
                  <button
                    type='button'
                ...
                <td className='py-1.5 pr-4'>
                  <div className='flex items-center gap-2'>
                    ...
                    <button
                      ...
                      className='hidden cursor-pointer items-center gap-1 rounded px-1.5 py-0.5 text-paragraph-xs text-muted-foreground hover:bg-accent group-hover:inline-flex'
                    >
                ...
                <td
                  className='relative py-1.5 pr-4'
          ...
          <tr>
            <td colSpan={99} className='py-1.5'>
              <button
                type='button'
                onClick={onCreate}
                className='inline-flex cursor-pointer items-center gap-1.5 rounded-md px-2 py-1 text-paragraph-xs text-muted-foreground transition-colors hover:text-foreground'
              >
