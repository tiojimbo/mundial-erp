    ...
    <div className='shrink-0 py-1.5'>
      <div className='flex w-full items-center px-10'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <Popover.Root>
            ...
            <Popover.Content
              ...
              showArrow={false}
              unstyled
              className='shadow-md w-52 rounded-xl bg-background p-2 ring-1 ring-inset ring-border'
            >
              ...
              <div className='flex items-center gap-1 px-1'>
                ...
                <button
                  ...
                  className='hover:bg-error-base/10 flex size-7 items-center justify-center rounded-lg text-error-base transition-colors'
                >
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='focus-within:ring-ring/20 flex h-[29px] w-40 items-center gap-1.5 rounded-lg border border-border bg-accent px-2.5 transition-all focus-within:border-ring focus-within:bg-background focus-within:ring-2'>
          ...
          <button
            ...
            className='hover:bg-foreground/90 ml-1 flex h-7 items-center gap-1.5 rounded-lg bg-foreground px-3 text-[13px] font-medium tracking-tight text-background transition-colors'
          >
