...
export function CreateDepartmentDialog({
  ...
  const abbr = name.trim() ? name.trim().substring(0, 2).toUpperCase() : '?';
          ...
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div className='grid gap-2 space-y-2'>
              <div className='flex items-center gap-4'>
                <div className='shrink-0'>
                  <span
                    className='text-xs relative flex size-8 shrink-0 items-center justify-center overflow-hidden rounded-lg font-medium text-white'
                    style={{
            ...
            <div className='grid gap-2 space-y-2'>
              <textarea
                ...
                className='shadow-xs focus-visible:ring-[oklch(0.708_0.165_254.624)]/50 flex min-h-16 w-full rounded-md border border-[oklch(0.922_0_0)] bg-transparent px-3 py-2 text-[14px] outline-none transition-[color,box-shadow] [field-sizing:content] placeholder:text-[oklch(0.556_0_0)] focus-visible:border-[oklch(0.708_0.165_254.624)] focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50'
              />
              <label className='text-[12px] font-medium text-[oklch(0.556_0_0)]'>
            ...
            <div className='flex items-center justify-between gap-2'>
              ...
              >
                <span
                  data-state={isPrivate ? 'checked' : 'unchecked'}
                  className='shadow-lg pointer-events-none block h-5 w-5 rounded-full bg-white ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0'
                />
              </button>
            </div>
            ...
            <div className='flex items-center justify-end gap-2 pt-2'>
              ...
              <button
                ...
                className='shadow-xs inline-flex h-9 cursor-pointer items-center justify-center rounded-md px-4 py-2 text-[14px] font-medium text-white outline-none transition-all disabled:cursor-not-allowed disabled:opacity-50'
