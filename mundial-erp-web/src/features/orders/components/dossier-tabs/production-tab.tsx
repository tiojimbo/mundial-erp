...
const VISIBLE_AFTER: OrderStatus[] = [
  'FATURADO',
  'PRODUZIR',
  'EM_PRODUCAO',
  'PRODUZIDO',
    ...
    return (
      <div className='flex flex-col items-center justify-center gap-2 py-12 text-text-soft-400'>
        ...
        <p className='text-paragraph-sm'>
          Producao disponivel apos faturamento
        </p>
        ...
        {productionOrders.length === 0 ? (
          ...
          productionOrders.map((po) => {
            ...
            return (
              <div
                key={po.id}
                className='mb-4 rounded-lg border border-stroke-soft-200 p-4'
              >
