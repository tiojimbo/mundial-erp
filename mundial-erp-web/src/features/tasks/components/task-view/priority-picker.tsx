    ...
    <div className='relative inline-flex'>
      ...
      {open && (
        <ul
          ...
          className='shadow-lg absolute left-0 top-full z-20 mt-1 flex min-w-[160px] flex-col rounded-[10px] border border-border bg-popover p-1'
        >
          {PRIORITIES.map((p) => (
            <li key={p}>
              <button
